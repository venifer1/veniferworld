...
import NotFound from "./MobileNotFound";
...
`;
const Content1Bottom = styled.div`
  height: 100%;
  display: flex;
  flex-direction: column;
  justify-content: center;
          ...
          <ProjectsView id={fadeOut ? "fadeAni" : ""}>
            ...
            <Content>
                ...
                <table>
                  ...
                  <tr>
                    ...
                    <td>
                      자판기 PCB 하드웨어 검증
                      <br />
                      자판기 통신 메인보드 펌웨어 개발 (Stm32f429)
                      <br />
                      자판기 기구물 제어 보드 2종 펌웨어 개발 (Atmega128-RTOS)
                      <br />
                      자판기 솔루션 프로그램 유지보수 (C#-WPF)
                      <br />
                      자판기 상품 설정용 프로그램 유지보수 (C#-WPF)
                      <br />
                      자판기 설정용 HMI 개발 (Nextion)
                      <br />
                      자판기 제어 테스트
                      <br />
              ...
              <Content1Bottom>
                <ul>
                  <li>
                    <Content1Img src={ImgP1_1} alt="" />
                  </li>
                  <li>
                    <Content1Img src={ImgP1_2} alt="" />
                  </li>
                  <li>
                    <Content1Img className="img350" src={ImgP1_3} alt="" />
                  </li>
                  <li>
                    <Content1Img className="img350" src={ImgP1_4} alt="" />
                  </li>
                  <li>
                    <Content1Img className="img350" src={ImgP1_5} alt="" />
                  </li>
                  <li>
                    <Content1Img className="img350" src={ImgP1_6} alt="" />
                  </li>
                  <li>
                    <Content1Img className="img350" src={ImgP1_7} alt="" />
                  </li>
                  <li>
                    <Content1Img className="img350" src={ImgP1_8} alt="" />
                  </li>
                  <li>
                    <Content1Img className="img350" src={ImgP1_9} alt="" />
                  </li>
                </ul>
              </Content1Bottom>
            </Content>
            ...
            <Content>
              <ContentTop>
                <table>
                  ...
                  <tr>
                    <th>개요</th>
                    <td>
                      실내공간에 설치되는 멀티자판기를 개발. 터치스크린을 통해서
                      상품을 선택하 여 결제가 완료되면 상품을 투출해주는 방식.
                      자판기는 서버와 통신하여 웹 페이지로 매출, 품절, 고장
                      정보를 확인할 수 있고 알림을 통해 문자 혹은 카카오톡으로
                      정보를 관리자에게 전송.
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      자판기 PCB 하드웨어 검증
                      <br />
                      자판기 메인보드 펌웨어 개발 (Stm32f429)
                      <br />
                      자판기 기구물 제어보드 개발 (Atmega128-RTOS)
                      <br />
                      자판기 솔루션 프로그램 개발 (C#-WPF)
                      <br />
                      자판기 상품 설정용 프로그램 개발 (C#-WPF)
                      <br />
                      모니터링 서버 구축 (AWS, Java)
                      <br />
                      모니터링 서버 웹 개발 (HTML, CSS, JavaScript,
                      PHP-CodeIgniter)
                      <br />
                      자판기 제어 테스트
                    </td>
              ...
              <Content2Bottom>
                <ul>
                  ...
                  <li>
                    <img src={ImgP2_10} alt="" />
                  </li>
                  <li>
                    <img src={ImgP2_11} alt="" />
                  </li>
                  <li>
                    <img src={ImgP2_12} alt="" />
                  </li>
                </ul>
              </Content2Bottom>
            </Content>
